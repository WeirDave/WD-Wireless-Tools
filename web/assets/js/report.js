(function () {
  ...
  /* The project segment of the file name, and where it came from.
     ...
     The stem is next and is kept whole - "SITE1 - BLD-03 - 100 Example St,
     Springfield, CA 90806 - B20 - PD" stays as it is. It is the answer whenever
  ...
  function apLabel(ap, mode) {
    ...
    // SITE4-01-00-01-AP05-001 fail to match and fall through to the whole
  ...
  /* A floor plan imported from CAD carries a generated name like
     "4563 Example TF_Overall Plan background_2026-08-14". The full name
