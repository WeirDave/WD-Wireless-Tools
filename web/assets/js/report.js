(function () {
  ...
  function renderAntennaReport(aps, opts, ctx) {
    ...
    floorOrder.forEach(function (fp) {
      ...
      sections += renderAntennaFloorSection(fp, floorAps, opts, ctx, floorIdx);
      floorIdx++;
    });
  ...
  function renderAntennaFloorSection(fp, aps, opts, ctx, floorIdx) {
    var sorted = aps.slice().sort(function (a, b) {
      return (a.name || '').localeCompare(b.name || '', undefined, { numeric: true });
    });
    var idx = (floorIdx != null ? floorIdx : 0) % 5;
