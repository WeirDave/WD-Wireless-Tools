...
> **macOS first launch:** if Gatekeeper blocks `run.command`, right-click the file, choose **Open**, and confirm **Open** once more.
...
Right-click `run.command`, select **Open**, and confirm **Open**. This is normally needed only on first launch.
